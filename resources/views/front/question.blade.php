                    ...
                    <div id="question">
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>システム開発案件が中心ですが、インフラ系・デザイン系・事務系など幅広くご紹介することが可能です。</br>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>案件によって異なりますが、月末締めの翌月末（30日）お支払いから月末締めの翌々月末（60日）お支払いになります。</br>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>スキルや経験によって異なりますが、弊社からお渡しする想定金額です。</br>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>案件終了の1か月前(現プロジェクト期間中)から次の案件などのご相談を伺います。</br>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>カウンセリング済みの場合、案件によっても異なりますが、早いもので1日で就業が決まることもございます。</br>
                                        平均すると登録～就業まで10日前後です。
                                    </p>
                                </li>
                                <li class="questionOpen"></li>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>案件によっては多少のスキル不足があっても、周りの方のサポートを受けながら参画できる案件もあります。</br>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>平日でしたらできる限りご希望の時間に合わせて調整をさせて頂きます。</br>
                                        また、状況によっては出張面談も致します。詳細はお気軽にご相談下さい。</p>
                                </li>
                                <li class="questionOpen"></li>
                            </ul>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>カウンセリングについては私服でも問題ありません。</br>
                                        お客様面談についてはスーツが基本となりますが、都度お伝えさせて頂きます。</p>
                                </li>
                                <li class="questionOpen"></li>
                            </ul>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>カウンセリング時に今までのご経歴・業務概要・得意分野・希望事項などを伺います。</br>
                                        アピールポイント・希望条件がございましたら是非お聞かせください。</br>
                                        </br>
                                        お客様面談については、面談が入った際は、事前に弊社担当者から想定される質問などをお伝えいたします。</p>
                                </li>
                                <li class="questionOpen"></li>
                            </ul>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>よりマッチした案件をご紹介するため、可能なかぎりご来社いただき、お話させて頂いております。</br>
                                        また、サイト上では公開できない非公開案件などの情報もございますので、是非一度ご来社下さい。</p>
                                </li>
                                <li class="questionOpen"></li>
                            </ul>
                        </div>
                        ...
                        <div class="question">
                            ...
                            <ul class="anserElement">
                                <li><p class="qaMark anserMark">A</p></li>
                                <li class="anserText">
                                    <p>フリーエンジニアになるために必要な経験は特にございません。</br>
                                        正社員として2～3年の経験を経た後、独立される方も多くいらっしゃいます。</br>
                                        独立する際に相談に来られる方もいらっしゃいますので、お気軽にご相談下さい。</p>
                                </li>
                                <li class="questionOpen"></li>
                            </ul>
                        </div>
