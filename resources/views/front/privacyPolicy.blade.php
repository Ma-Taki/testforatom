...
<div class="wrap">
  ...
  <div class="main-content privacy-policy">
    <h2 class="main-content__title">プライバシーポリシー</h2>
    <hr class="hr-2px-solid-5e8796">
    <div class="main-content__body">
      <div class="content__element">
        <h2 class="content__title">個人情報保護方針</h2>
        <hr class="hr-1px-dashed-333">
        <div class="content__body">

          <div class="privacy-policy__element">
            <h3 class="element__title">1.個人情報保護の目的</h3>
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">2.個人情報の取得について</h3>
            <p class="element__body">
              当社が個人情報の取得を行う場合は、</br>
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">3.個人情報の利用について</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">4.個人情報の適正管理について</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">5.法令遵守について</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">6.継続的改善について</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">7.苦情相談窓口</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <p class="element__body cmmn__text-align-right">
              制定日 2011年2月1日<br>
              <br>
              ソリッドシード株式会社<br>
              代表取締役　妹尾　準
      ...
      </div><!-- ./content__element -->

      <div class="content__element">
        <h2 class="content__title">個人情報の取扱いについて</h2>
        <hr class="hr-1px-dashed-333">
        <div class="content__body">
          <div class="privacy-policy__element">
            <p>
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">1.事業者の名称</h3>
            <p class="element__body">
              ソリッドシード株式会社
            </p>
          </div>
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">2.当社の個人情報管理者</h3>
            <p class="element__body">
              個人情報保護管理者：妹尾　準
            </p>
          </div>
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">3.連絡先</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">4.利用目的</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">5.第三者提供</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">6.委託</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">7.提供の任意性とその結果</h3>
            <p class="element__body">
          ...
          <div class="privacy-policy__element">
            <h3 class="element__title">8.個人情報の開示等の要求</h3>
            <p class="element__body">
