...
<div class="col-md-10">
	<div class="content-box-large">
		  <div class="panel-heading">
				<div class="panel-title">メールマガジン配信</div>
                            ...
                            <div class="navbar">
							    <div class="navbar-inner">
								    <ul class="nav nav-pills">
								  	    <li class="active"><a href="#tab1" data-toggle="tab">メール</a></li>
								        <li><a href="#tab2" data-toggle="tab">送信設定</a></li>
							        </ul>
								</div>
							</div>
                            ...
                            <div class="tab-content">
							  ...
							  <div class="tab-pane active" id="tab1">
								<div class="form-group">
								  ...
								  <div class="col-sm-10">
									<input type="text" class="form-control" id="subject" name="subject" placeholder="件名" value="{{ old('subject') }}">
								  </div>
								</div>
								<div class="form-group">
                                ...
                                <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="form-group">
										    ...
										    <div class="col-sm-10">
                                                <div class="radio">
                                                  <label>
										            <input type="radio" name="toAddressesFlag" value="0" @if(old('toAddressesFlag') != '1' && old('toAddressesFlag') != '2') checked @endif> 配信希望ユーザのみ
                                                  </label>
                                                </div>
                                                <div class="radio">
                                                  <label>
                                                    <input type="radio" name="toAddressesFlag" value="1" @if(old('toAddressesFlag') == '1') checked @endif> すべての有効なユーザ
                                                  </label>
                                                </div>
                                                <div class="display-flex">
                                                  <div class="radio">
                                                    <label>
                                                      <input type="radio" name="toAddressesFlag" value="2" @if(old('toAddressesFlag') == '2') checked @endif> メールアドレスを指定
                                                    </label>
                                                  </div>
                                                  ...
                                                  <div class="wrap-table">
                                                    <div class="input-group input-to-address">
                                                      ...
                                                      <input type="text" class="form-control" name="toAddresses" id="js__toAddresses" data-role="tagsinput">
                                                    </div>
                                                  </div>
										        </div>
										    </div>
                                        ...
                                        <div class="form-group input-cc-address">
										    ...
										    <div class="col-sm-10">
										        <input type="text" class="form-control" name="ccAddresses" id="js__ccAddresses" data-role="tagsinput">
										    </div>
										</div>
                                        ...
                                        <div class="form-group input-bcc-address">
										    ...
										    <div class="col-sm-10">
										        <input type="text" class="form-control" name="bccAddresses" id="js__bccAddresses" data-role="tagsinput">
										    </div>
										</div>
                                        ...
                                        <div class="form-group">
										  ...
										  <div class="col-sm-10">
                                            <div class="radio">
                                              <label>
										        <input type="radio" name="sendDateFlag" value="0" @if(old('sendDateFlag') != '1') checked @endif> 即時
                                              </label>
                                            </div>
                                            <div class="display-flex">
                                              <div class="radio">
                                                <label>
                                                  <input type="radio" name="sendDateFlag" value="1" @if(old('sendDateFlag') == '1') checked @endif>時間を指定する&nbsp;
                                                </label>
                                              </div>
                                              ...
                                              <div class="wrap-table">
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" class="form-control" name="sendDateTime" id="js__send-DateTime" value="{{ old('sendDateTime') }}" autocomplete="off">
                                                </div>
                                              </div>
										    </div>
                                          </div>
