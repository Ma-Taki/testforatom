    ...
    <div class="row">
        <div class="content-box-large">
            <div class="panel-heading">
                <div class="panel-title" style="font-size:20px">お知らせ編集(フロント画面)</div>
            </div>
            <div class="panel-body">
                ...
                <form class="form-horizontal" name="frontNewsForm" role="form" method="POST" onSubmit="mutualApplyBeforeSubmit()" action="{{ url('/admin/front-news/modify') }}">
                    <fieldset>
