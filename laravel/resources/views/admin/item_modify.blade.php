...
@endforeach
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                (1000文字まで)</br>
                                <textarea name="item_detail" rows="15" cols"60" class="form-control" style="font-size:12px" id="tagTextArea">{{ HtmlUtility::setTextValueByRequestDefault($item->detail, old('item_detail'),'
【募集人数】
名
