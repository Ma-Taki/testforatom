...
<div class="wrap">
  ...
  <div class="main-content item-all">
    <div class="main-content-left">
      ...
      <span class="item-all-count">該当件数：
        <span class="num">{{ $itemList->total() }}</span>件
      </span>
      ...
      <div class="main-content__body">
        <div class="content__element">
                        ...
                        <div class="tabContent">
                          <ul>
                            @foreach(FrntUtil::SEARCH_CONDITION_RATE as $key => $value)
                              <li class="tabContentElementHalf">
                                <label>
                                  <input type="radio" class="srchCndtns_radio" name="search_rate" value="{{ $key }}">{{ $value }}  
                                </label>
                              </li>
                            @endforeach
                          </ul>
                        ...
                        <div class="tabContent">
                          <ul>
                            @foreach(Ms_job_types::getNotIndexOnly() as $job_type)
                              <li class="tabContentElementHalf">
                                <label>
                                  <input class="srchCndtns_chkBx" type="checkbox" name="job_types[]" value="{{ $job_type->id }}">{{ $job_type->name }}
                                </label>
                              </li>
                            @endforeach
                          </ul>
          ...
          ?>
          @if($params['nodata'])
            <div class="alert alert-danger alert-nodata">
              <ul>
                <li>該当案件はありませんでした。終了した案件ですが、探す際の参考としてご覧ください</li>
              </ul>
            </div>
          @endif
          <div id="itemList">
          ...
          @if(!$params['nodata'])
            <div class="paginate invisible-sp">
              {!! $itemList->appends($params)->render() !!}
            </div>
