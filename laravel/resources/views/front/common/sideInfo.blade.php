...
-->
	...
	<div class='wordpress-sidebar invisible-sp'>
	    <ul>
	    	<!-- WEB塾超現場主義 -->
			<li>
				<a href="https://goo.gl/225jcM" target=”_blank”>
					<img src="/front/images/chogenba_480x200.jpg" alt="Engineer-Route News">
				</a>
			</li>
			<!-- fabbit八王子 -->
			<li>
				<a href="http://fabbit-hachioji.jp/" target=”_blank”>
					<img src="/front/images/fabbit_hachioji_480x200.jpeg" alt="Engineer-Route News">
				</a>
			</li>
	    </ul>
	</div>
