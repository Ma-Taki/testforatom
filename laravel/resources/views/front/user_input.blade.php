...
@section('canonical', url('/user/regist'))
@section('content')
<?php
  ...
  <div class="main-content mail-auth">
    ...
    <div class="main-content__body">
      <div class="content__element">
        ...
        @endif
        @if(Session::has('resend_comp'))
          <div class="alert alert-info"><ul><li>送信が完了しました。</li></ul></div>
        @endif
                ...
                <div class="regist__sns-btn-contents">
                  <div class="regist__sns-btn">
                    <a href="/login/sns/github?func=regist" class="regist__github">
                      <img class="regist__sns_icon" border="0" src="../../front/images/github.png" alt="github">
                      <p class="regist__sns_text">GitHubで登録</p>
                    </a>
                  </div>
                  <div class="regist__sns-btn">
                    <a class="regist__facebook" href="/login/sns/facebook?func=regist">
                      <img class="regist__sns_icon" border="0" src="../../front/images/facebook.png" alt="facebook">
                      <p class="regist__sns_text">Facebookで登録</p>
                    </a>
                  </div>
                  <div class="regist__sns-btn">
                    <a href="/login/sns/twitter?func=regist" class="regist__twitter">
                       <img class="regist__sns_icon" border="0" src="../../front/images/twitter.png" alt="twitter">
                      <p class="regist__sns_text">Twitterで登録</p>
                    </a>
                  </div>
