...
function opencage_customize_register($wp_customize) {
    ...
    $sidetext = get_theme_mod( 'opencage_color_sidetext', '#44444444');
...
#logo a:hover,.nav li a:hover,.nav_btn:hover{color:<?php echo $headerlinkhover; ?>;}
@media only screen and (min-width: 768px) {
.nav > li > a:after{background: <?php echo $headerlink; ?>;}
...
/* サイドバー */
#sidebar1{color: <?php echo $sidelink; ?>;}
...
function opencage_global_customizer($wp_customize) {
	...
	$wp_customize->add_control( 'other_options_headerundertext', array(
	    'label' =>'ヘッダー下お知らせテキスト',
		'description' => '<span style="font-size:10px;">ヘッダー下にお知らせを表示できます。イベントの告知や読んで欲しい記事などへのリンクを設置したりと、使い方は様々！</span>',
	...
	$wp_customize->add_control( 'other_options_headerunderlink', array(
	    'label' =>'ヘッダー下お知らせリンク',
		'description' => '<span style="font-size:10px;">ヘッダー下のお知らせにリンクを設置可能です。</span>',
...
function opencage_toppage_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_control( 'opencage_toppage_headeregtext', array(
		...
		'description' => '<span style="font-size:10px;">【トップページヘッダーを表示するなら必須】推奨はローマ字です。日本語でも表示は可能ですがフォントの見た目が変わります。</span>',
	...
	$wp_customize->add_control( 'opencage_toppage_headerjptext', array(
		...
		'description' => '<span style="font-size:10px;">【アニメーションヘッダーを表示するなら必須】小さな補足テキストが入ります。</span>',
	    'section' => 'opencage_toppage_section',
	    'type' => 'textarea',
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'opencage_toppage_headerbgsp', array(
		...
		'description' => '<span style="font-size:10px;">スマートフォン用のヘッダー背景画像を設定できます。入力しなかった場合はPC用が表示されます。</span>',
		'section'    => 'opencage_toppage_section',
